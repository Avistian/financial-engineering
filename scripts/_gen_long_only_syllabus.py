...
Y4 = [
    dict(
        ...
        teach=[
            ...
            'This quarter is Year 4 Q1 — the data kit. The rest of Years 4–5 use this store. You do not start a long-only backtest until unit 130 is green.',
        ],
    ...
    dict(
        ...
        teach=[
            'This is the standing adjuster. Unit 133 will use it as the return you actually earn; do not rebuild a private price file later.',
    ...
    dict(
        ...
        teach=[
            'Unit 132 as a table: date × name → in or out. IPOs, index adds, index drops, delists.',
            'Survivors-only vs PIT, again, because this is the store every later lesson will query.',
            'A reconstitution calendar is part of membership, not a surprise in 128.',
        ],
        trap="Downloading 'current S&amp;P names' and filling ten years backward (132's trap, now as a failing unit test on the store).",
    ),
    dict(
        n=124,
    ...
    dict(
        ...
        teach=[
            ...
            "After-close vs before-open. Unit 176's leak is a failing test here.",
    ...
    dict(
        ...
        teach=[
            ...
            'The auction print is not always the last trade. Teach the difference (172).',
    ...
    dict(
        ...
        teach=[
            ...
            'Days-to-trade at 3% participation for a stated AUM. This number feeds 173 and 192.',
    ...
    dict(
        ...
        teach=[
            'Unit 139 as a table, not a vibe. Cap-weight, equal-weight, float flags.',
    ...
    dict(
        ...
        skill='Query the store for a Year-4 monthly panel and a Year-5 daily panel; both pass the leak tests from 122–129.',
        kind="chk",
        teach=[
            'Survivorship test (123). Restatement test (124). Timestamp test (125). ADV causality (127). Benchmark membership (128).',
    ...
    dict(
        ...
        teach=[
            ...
            'Book/price and earnings/price: define each in words, then as a ratio. The ratio must use the book or earnings that was known that morning (unit 132 / later 124).',
    ...
    dict(
        ...
        trap='Keeping a characteristic because the story is pretty after you saw the t-stat. Pre-commit the list (unit 167 will make this a habit).',
    ),
    dict(
        n=139,
    ...
    dict(
        ...
        skill='Put 131–139 on one page: PIT universe, total returns, 12-1 + value, IR vs a named benchmark, a multiple-testing note.',
        kind="chk",
        teach=[
    ...
    dict(
        ...
        teach=[
            ...
            'This linear model is the thing the tree model in 145 must beat. Teach it as a respected baseline, not a straw man.',
        ],
    ...
    dict(
        ...
        teach=[
            ...
            'This is still a score. Holdings come later (151–160).',
        ],
    ...
    dict(
        ...
        trap="Reporting the blend's raw IR and calling the tree a win when it is 12-1 in costume (Year 5 unit 189 is the daily twin).",
    ),
    dict(
        n=149,
    ...
    dict(
        ...
        teach=[
            ...
            'Compare turnover and IR of these three to the same-score long-short book. The gap is the long-only tax (153 will name it transfer coefficient).',
        ],
    ...
    dict(
        ...
        teach=[
            ...
            'Re-warm Markowitz (081): unconstrained MVO is brittle. That is why 154–159 exist.',
        ],
    ...
    dict(
        ...
        teach=[
            ...
            'Same alpha, three mandates: long-only, long-short, 140/30 (a little short sleeve). Teach 140/30 as an overlay, not the default.',
        ],
    ...
    dict(
        ...
        teach=[
            ...
            'A book that hugs the index to satisfy every cap is a closet indexer (168). Tracking error will look tiny and IR will look stable.',
        ],
    ...
    dict(
        ...
        teach=[
            ...
            'Half-life of the score (from 143) is an input to this problem, not a separate hobby.',
        ],
    ...
    dict(
        ...
        teach=[
            ...
            'A simple tilt (151) is often more stable than a fancy robust program. Honesty about that is in-syllabus.',
        ],
...
Y5 = [
    dict(
        ...
        teach=[
            ...
            'A mid-month split or spinoff changes share counts. The wealth series must stay honest (133, again).',
            'P&amp;L split into selection (you picked well) vs interaction (drift helped or hurt). Preview of 165.',
        ],
    ...
    dict(
        ...
        teach=[
            'Re-warm 088 / 156. Monthly capacity is larger than daily (Year 5 / 199) because you trade less.',
    ...
    dict(
        ...
        teach=[
            'Leaked fundamentals (142). Index-hugging (155). Hidden beta (137 / 141). Overfit optimizer (159 / 048).',
    ...
    dict(
        ...
        skill='Add a restricted list and a 140/30 sleeve, and measure IR and turnover change.',
        teach=[
            'Restricted list: names you may not own (ESG, compliance, a client ban). The optimizer must treat them as a hard zero.',
            '140/30: 140% long, 30% short. A little short sleeve. Not the default mandate.',
    ...
    dict(
        n=170,
        title='Monthly long-only capstone',
        skill='Defend a PIT, walk-forward, cost-aware monthly long-only book on net IR vs a named benchmark, including beta, the no-short tax, and capacity.',
        kind="chk",
        teach=[
    ...
    dict(
        ...
        trap="Taking Year 4's monthly optimizer and running it every close. Unit 191 exists to make that pain concrete; preview it here.",
    ),
    dict(
        n=172,
        ...
        trap="Scoring at today's close to 'predict' today's close-to-close return. That is the same-day leak (182).",
    ),
    dict(
        n=173,
    ...
    dict(
        ...
        teach=[
            'If you hold through the close, you eat the overnight gap (201). If you flatten, you pay two tickets (exit today, enter tomorrow) and miss the overnight return.',
            "A lot of a daily book's volume happens at the auction (198). Who you are at 15:50 is a design choice.",
    ...
    dict(
        ...
        teach=[
            'More days ⇒ more trials ⇒ more false winners (007, 138). Daily does not relax the bar; it invites more searching.',
    ...
    dict(
        ...
        kind="chk",
        teach=[
            'Liquid mask from 173. Reversal and PEAD, long-only, net IR.',
    ...
    dict(
        ...
        teach=[
            ...
            'A 5-day triple-barrier (035) is legal if the hold is 5 days. Overlap then becomes 184.',
            'Open-to-close drops the overnight. That is a different mandate (172).',
        ],
    ...
    dict(
        ...
        teach=[
            'Same IC idea as 143, faster grid.',
            'A score dead by tomorrow morning does not belong in a 5-day hold.',
            'This number becomes the half-life in 197.',
        ],
    ...
    dict(
        ...
        teach=[
            'Same tools as 145, daily rows, uniqueness weights from 184.',
            'Purged walk-forward. No i.i.d. K-fold.',
            'Must beat or honestly lose to reversal. A tree that is reversal in costume fails 189.',
        ],
        trap='A giant in-sample daily fit with 210 features and a pretty IC.',
    ),
    dict(
        n=186,
    ...
    dict(
        ...
        teach=[
            ...
            'Compare with/without flags. Leftover PEAD after the flag is the test of whether the tree already stole 176.',
        ],
    ...
    dict(
        ...
        teach=[
            ...
            'One long-only NAV, two rebalance clocks (234 / 208 will operationalize this).',
    ...
    dict(
        ...
        trap='A model card that never mentions 174.',
    ),
    dict(
        n=190,
        ...
        kind="chk",
        teach=[
            'Same structure as 150, daily clock, uniqueness weights, costs on the IR.',
        ],
    ...
    dict(
        ...
        teach=[
            'Take the 160 optimizer, change the calendar to daily, do not retune the turnover penalty.',
            'Turnover explodes. Net IR dies. That plot is the lesson.',
            "The fix is not 'trade less for vibes.' The fix is 192–197: ADV caps, impact, multi-period at a 1–5 day half-life.",
        ],
    ...
    dict(
        ...
        teach=[
            'Close-only: one book a day, auction-heavy (198).',
    ...
    dict(
        ...
        teach=[
            ...
            "Paper vs impact-adjusted IR. The curve vs AUM is 199's cousin.",
        ],
    ...
    dict(
        ...
        teach=[
            "Same idea as 163, daily. The hedge must move when the stock cart's beta moves.",
    ...
    dict(
        ...
        teach=[
            'Gârleanu–Pedersen / Boyd again, with the half-life from 183.',
    ...
    dict(
        ...
        trap="Assuming you get the close print as a fill. You get a fill in the auction, which can differ (172's auction jump).",
    ),
    dict(
        n=199,
...
Y6 = [
    dict(
        ...
        teach=[
            "You are long into the open if you held the close (177). One ugly gap can be the week's P&amp;L.",
    ...
    dict(
        ...
        teach=[
            'More events per hold than Year 4. The same adjuster (133 / 122) now runs every night.',
    ...
    dict(
        ...
        teach=[
            'Same discipline as 167, faster clock. Participation cap is a required line.',
        ],
    ...
    dict(
        ...
        teach=[
            'Four bugs, one notebook the learner did not write. Twin of 168.',
        ],
    ...
    dict(
        n=209,
        title='Overlays: 140/30 and synthetic market-neutral',
        skill='Same names, three mandates: long-only, 140/30, futures-hedged; say what IR and Sharpe each claim.',
        teach=[
            'Cash stays long-only under the futures overlay (163/196). 140/30 is a different permission.',
    ...
    dict(
        n=210,
        title='Daily long-only capstone',
        skill='Defend a liquid, walk-forward, ADV-and-cost-aware long-only book on net IR, with capacity vs the monthly book (170).',
        kind="chk",
        teach=[
    ...
    dict(
        ...
        teach=[
            'Sentences from 155/192 become fields: name cap, sector cap, ADV participation, turnover penalty, long-only flag.',
    ...
    dict(
        ...
        teach=[
            ...
            'A standing table: date, name, predicted, realized, shortfall. This is how 162/198 stay honest after go-live.',
        ],
    ...
    dict(
        ...
        teach=[
            'The adjuster from 122 must run on the ledger. Share counts change. Open limit prices may need to change.',
    ...
    dict(
        ...
        teach=[
            ...
            'Cutoff times. A late MOC is a missed trade (203).',
            'This is 198 as operations, not as a shortfall formula.',
        ],
    ...
    dict(
        ...
        teach=[
            ...
            'A model that is always optimistic will make every paper IR a fiction (162).',
            'Feed the gap back into 156/194. That loop is research, not operations theater.',
        ],
    ...
    dict(
        ...
        teach=[
            'If it is not written, it will recur. This is the operational twin of a research autopsy (149).',
        ],
        trap='Fixing the file by hand and not adding a test to 130/220.',
    ),
    dict(
        n=234,
        ...
        teach=[
            'Unit 208 as operations: two clocks, one ledger (216), one restricted list (228), one kill switch (226).',
    ...
    dict(
        ...
        teach=[
            ...
            'After-tax P&amp;L is a different exam. Teach it as an overlay after the pre-tax capstones (170 / 210) are honest.',
    ...
    dict(
        ...
        teach=[
            'Twin of 167/206, now with broker and reconcile. Duration (e.g. 20 days), AUM, sleeve, abort (225/226), success definition.',
    ...
    dict(
        ...
        teach=[
            ...
            'This is 168/207 for the desk, not for the ranker.',
        ],
    ...
    dict(
        ...
        skill='Defend 20 paper (or tiny live) days: store passes 130, backtest=live on a morning (220), week reconciles (230), runbook, proceed/kill.',
        kind="exit",
        teach=[
...
def main():
    ...
    intro4 = """
  <p>
    Everyday picture: first you build a store of facts that could have been known
    that morning. Then you rank stocks about once a month, an optimizer turns those
    ranks into a shopping cart you may only <em>own</em>, and you are judged on beating
    a named index after costs. This page is <strong>what each lesson must teach</strong>,
    in order. Labs are not written yet.
  </p>
  <p>
    Years 1–3 stay required. Unit numbers match study order: the data kit is
    121–130, then the monthly book through the optimizer (131–160). Running and
    defending that book is Year 5 Q1. The faster clock is
    <a href="year-5-lessons.html">Year 5</a> then
    <a href="year-6-lessons.html">Year 6</a>.
  </p>
"""
    intro5 = """
  <p>
    Everyday picture: you first <em>run</em> last year's monthly book (drift, fills,
    crashes, attribution) and defend it. Then you switch clocks: each afternoon you
    re-rank for the next day or few, the optimizer may only own shares and may not
    take more than a slice of each name's daily volume. Labs are not written yet.
  </p>
  <p>
    Same long-only rules as <a href="year-4-lessons.html">Year 4</a>. Different clock
    (this course's mid-frequency) from Q2 on. The store from 121–130 is already built.
  </p>
"""
    intro6 = """
  <p>
    Everyday picture: you defend the daily book, then you need a loop that turns
    the store into orders, a ledger that adds up, and a button that stops you.
    This year finishes the faster book and then teaches the desk.
  </p>
  <p>
    Study order is the unit numbers. Years 1–5 stay required.
  </p>
"""
    nav4 = _nav(
        [
    ...
    (root / "year-4-lessons.html").write_text(
        page(
            ...
            "Units 121–160 · store + monthly book through the optimizer · no labs yet",
            intro4,
            Y4,
            nav4,
        ),
    ...
    (root / "year-5-lessons.html").write_text(
        page(
            ...
            "Units 161–200 · defend the monthly book, then daily research through the optimizer · no labs yet",
            intro5,
            Y5,
            nav5,
        ),
    ...
    (root / "year-6-lessons.html").write_text(
        page(
            ...
            "Units 201–240 · defend the daily book, then paper and live · no labs yet",
            intro6,
            Y6,
            nav6,
        ),
