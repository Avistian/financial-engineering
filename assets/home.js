 ...
 * year/quarter sections. Stores last-opened lesson in localStorage so the
 * "Continue" banner resumes where you left off.
 */
(function (global) {
  "use strict";

  var STORAGE_KEY = "feq-last-lesson";
  ...
  // labs/0004-foo.ipynb -> labs/html/0004-foo.html
