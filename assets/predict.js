 ...
 *     prompt: "Before reading: a market buy for 500 lots against this book fills at an average of…",
 *     options: [
 *       { label: "Exactly the best ask price", value: "best" },
 *       { label: "Worse than the best ask",     value: "worse" }
 *     ],
 *     correct: "worse",
 *     reveal: "It walks the book — level 1, then level 2 — so the average fill is worse than the top quote."
 *   });
 *
 * Config:
