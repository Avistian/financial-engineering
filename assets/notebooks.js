 ...
 * Binder runs the true environment (binder/requirements.txt); Colab clones the repo
 * via each notebook's bootstrap cell.
 */
(function (global) {
  "use strict";

  var REPO = "Avistian/financial-engineering";
  var BRANCH = "main";

  function padId(n) { return String(n).padStart(4, "0"); }

  function htmlPathFor(labPath) {
    // labs/0008-foo.ipynb -> labs/html/0008-foo.html
  ...
  function manifestFetchUrl(base) {
    ...
    var meta = document.querySelector('meta[name="feq-manifest-version"]');
